...
(function(){
     ...
     */
        ...
        BMapLib.MarkerClusterer = function(map, options){
            ...
            this._gridSize = opts["gridSize"] || 60;   //默认60

            this._maxZoom = opts["maxZoom"] || 16;      //默认18级

            this._minClusterSize = opts["minClusterSize"] || 2; //默认2
...
//源码默认显示点聚合的覆盖物数量，这里按我们的需求显示舆情消息总数。
        /***   开始     ***/
//        this._clusterMarker.setText(this._markers.length);
        var msgcount = 0;
        this._markers.forEach(function (obj) {
            msgcount=Number(msgcount)+Number(obj.z.title);
        });
        this._clusterMarker.setText(msgcount);
        /***   结束     ***/
